...
if len(sys.argv) <2:
    ...
    #CARGAR BASE DATOS:
    db_clientes = sqlalchemy.create_engine('sqlite:///C:\\Users\\Aalbornoz\\Documents\\python_test\\database.db3\\clientes.db')
    clientes.to_sql('clientes', db_clientes, if_exists="replace")
    db_emails = sqlalchemy.create_engine('sqlite:///C:\\Users\\Aalbornoz\\Documents\\python_test\\database.db3\\emails.db')
    emails.to_sql('emails', db_emails, if_exists="replace")
    db_phones = sqlalchemy.create_engine('sqlite:///C:\\Users\\Aalbornoz\\Documents\\python_test\\database.db3\\phones.db')
